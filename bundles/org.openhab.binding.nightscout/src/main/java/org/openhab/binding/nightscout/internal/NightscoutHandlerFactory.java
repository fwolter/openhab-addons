...
/**
 * The {@link NightscoutHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
...
public class NightscoutHandlerFactory extends BaseThingHandlerFactory {
    ...
    @Activate
    public NightscoutHandlerFactory(@Reference HttpClientFactory httpClientFactory,
