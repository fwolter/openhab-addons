...
public class ButtonStatus extends AbstractMessageBody {
    ...
    public boolean eventTypePress() {
        return "Press".equalsIgnoreCase(buttonEvent.eventType);
    }

    public boolean eventTypeRelease() {
        return "Release".equalsIgnoreCase(buttonEvent.eventType);
    }
}
